...
<footer>
        ...
        <div class="footer-bottom">
                <p>© <?php echo date('Y'); ?> Mentora. Tous droits réservés. | <a href="admin_login.php" style="color: #666; text-decoration: none; font-size: 0.8em;">Admin</a></p>
            </div>
    </footer>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Only run preloader code if preloader element exists
    if (preloader) {
        ...
        // Handle navigation links (but exclude dashboard tabs)
        document.querySelectorAll('a:not([target="_blank"]):not([href^="#"]):not([href^="javascript:"]):not(.dashboard-tab):not(.tab-link)').forEach(link => {
