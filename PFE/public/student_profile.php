...
// Debug: Add this temporarily to see what data we have
echo "<!-- DEBUG: Student ID: $studentId -->";
echo "<!-- DEBUG: Sessions found: " . count($calendar_sessions_raw) . " -->";
echo "<!-- DEBUG: Sessions data: " . print_r($calendar_sessions_raw, true) . " -->";
echo "<!-- DEBUG: Calendar data: " . print_r($sessions_for_calendar, true) . " -->";
